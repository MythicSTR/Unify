    ...
    <div className="change-form-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="__form-group">
          ...
          <input type="password" id="oldpassword" className="_form-control" placeholder='Old Password' value={oldpassword} onChange={handleOldPasswordChange} />
        </div>
        <div className="__form-group">
          <label htmlFor="password">New Password:</label>
          <input type="password" id="newpassword" className="_form-control" placeholder='New Password' value={newpassword} onChange={handleNewPasswordChange} />
        </div>
